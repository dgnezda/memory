...
export default function Home() {
  ...
  return (
    <main className="flex h-full flex-col flex-wrap items-center bg-slate-50">
      ...
      <Link
        href="/dashboard/game"
        className={`md:my-20 mt-2 mb-40 flex items-center gap-5 self-auto rounded-lg ${mainColors.main} px-6 py-3 text-sm font-bold text-white transition-colors ${mainColors.hover} md:text-base`}
      >
        <span>Play</span>{' '}
