  ...
  return (
    <div className="flex h-full flex-col px-3 py-4 lg:px-2">
      <div className='hidden lg:block'>
          <div className="mb-2 flex h-20 items-end justify-start rounded-lg bg-blue-400 p-4 lg:h-40">
      ...
      <div className="flex grow flex-row justify-between space-x-2 lg:flex-col lg:space-x-0 lg:space-y-2">
        <NavLinks />
        <div className="hidden h-auto w-full grow rounded-lg bg-gray-50 lg:block"></div>
        {/* <form>
